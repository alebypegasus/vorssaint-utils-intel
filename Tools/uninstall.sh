...
rm -rf "$HOME/Library/Application Support/$BUNDLE" "$HOME/Library/Application Support/$LEGACY_BUNDLE"
rm -rf "$HOME/Library/Caches/$BUNDLE" "$HOME/Library/Caches/$LEGACY_BUNDLE"
...
rm -rf "$HOME/Library/HTTPStorages/$LEGACY_BUNDLE" "$HOME/Library/HTTPStorages/$LEGACY_BUNDLE.binarycookies"
...
rm -f "$HOME/Library/Preferences/ByHost/$LEGACY_BUNDLE".*.plist(N)
