...
Open the bug report form from the [new issue](https://github.com/alebypegasus/vorssaint-utils-intel/issues/new/choose) page. Please bring your Vorssaint version from Settings under About, your macOS version, and clear steps to reproduce. The notes on [reporting a useful bug](docs/TROUBLESHOOTING.md#reporting-a-useful-bug) spell out what helps.

## Request a feature

Open the feature request form from the same [new issue](https://github.com/alebypegasus/vorssaint-utils-intel/issues/new/choose) page. Describe the problem you want solved rather than only a specific solution, since that makes the need much clearer. You can also browse and back existing ideas in the [open issues](https://github.com/alebypegasus/vorssaint-utils-intel/issues).
